...
You don't have to go through `heim` to run a library model — the files are
...
```bash
GGUF="$HEIM_LIBRARY_ROOT/gguf/lmstudio-community/gemma-4-12B-it-QAT-GGUF/gemma-4-12B-it-QAT-Q4_0.gguf"
...
```bash
MLX="$HEIM_LIBRARY_ROOT/mlx/lmstudio-community/Qwen3.5-4B-MLX-4bit"
