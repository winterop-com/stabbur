...
from stabbur.models import Catalog, ModelEntry, ModelSource, PullResult
from stabbur.sources import huggingface, lmstudio, ollama
...
def pull(
    ...
    match source:
        ...
        case ModelSource.voice:
            from stabbur.voice import importer as voice_importer  # noqa: PLC0415 - keep voice deps lazy
