"""Presentation helpers for the scripted ``stabbur chat -p`` path.

Interactive chat now runs in the full-screen Textual app (:mod:`stabbur.chat_tui`);
...
def assistant_prefix(console: Console, *, inline: bool) -> None:
    ...
    console.print("[bold cyan]stabbur[/] [grey62]›[/] ", end="" if inline else "\n")
