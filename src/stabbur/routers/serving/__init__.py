...
on import. The assembled ``router`` is re-exported here and mounted by :mod:`stabbur.app`.
...
from stabbur.routers.serving import core, chat, assistant, mcp, voice, proxy  # noqa: F401,I001 - register routes, in order
from stabbur.routers.serving._base import get_conf, get_http, get_lifecycle_lock, get_manager, router
