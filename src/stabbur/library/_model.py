...
if TYPE_CHECKING:
    from stabbur.voice.registry import VoiceModel
...
class LibraryModel(BaseModel):
    ...
    """True if this lives in the Ollama store — runnable only via Ollama, not stabbur."""
...
def _voice_spec(name: str) -> "VoiceModel | None":
    ...
    from stabbur.voice import registry  # noqa: PLC0415 - avoid importing voice on every library import
