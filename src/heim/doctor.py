...
Checks cover the things that make ``heim run/serve`` actually work: the runtime
binaries heim spawns (llama.cpp / MLX), the library location, what's in it, and
...
from heim import host, mcpservers, runtime
