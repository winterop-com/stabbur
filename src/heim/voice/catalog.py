...
(``~/.cache/huggingface/hub``), *not* in heim's portable library — so they don't travel with
...
``heim voice list`` and for importing cache -> library.
"""
...
from heim.models import _human_size
from heim.voice.registry import BUILTIN, VoiceModel
...
class VoicePresence(BaseModel):
    ...
    def available(self) -> bool:
        """Whether the model is present anywhere heim can reach it."""
