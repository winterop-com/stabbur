...
heim's ``heim benchmark`` command drives suites deterministically by importing ``core``
...
Run standalone over stdio: ``heim-benchmark`` (or ``python -m heim.benchmark``).
"""
...
mcp: FastMCP = FastMCP("heim-benchmark")
