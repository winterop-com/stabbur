...
from heim.models import Catalog, ModelEntry, ModelSource, PullResult
from heim.sources import huggingface, lmstudio, ollama
...
def pull(
    ...
    match source:
        ...
        case ModelSource.voice:
            from heim.voice import importer as voice_importer  # noqa: PLC0415 - keep voice deps lazy
