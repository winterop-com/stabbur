"""Render a conversation to Markdown — the one transcript format heim writes.

Both the Textual TUI's ``/export`` and the CLI's ``heim chat --save`` land here, so a saved
