"""Presentation helpers for the scripted ``heim chat -p`` path.

Interactive chat now runs in the full-screen Textual app (:mod:`heim.chat_tui`);
...
def assistant_prefix(console: Console, *, inline: bool) -> None:
    ...
    console.print("[bold cyan]heim[/] [grey62]›[/] ", end="" if inline else "\n")
