...
from heim.models import HubModel, ModelEntry, ModelFormat, ModelSource, PullResult
from heim.sources.base import dir_stats, safe_join
...
def _pull_size(repo: str) -> int:
    """Approximate bytes ``heim pull`` would download for ``repo``.
