...
import pytest
from kodo_mcp_files.core import FilesSettings, list_dir, read_text, safe_join, search, write_text
...
def test_writes_gated_by_flag(tmp_path: Path) -> None:
    ...
    with pytest.raises(PermissionError, match="KODO_FILES_WRITABLE"):
