...
// names. Minting never leaves the page: stabbur only receives the extracted token via /api/assistant/bind.
...
export const MINT_DESCRIPTION = "stabbur assistant token";
