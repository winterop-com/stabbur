...
// build time via the __STABBUR_FLAVOR__ define in wxt.config.ts (driven by the STABBUR_FLAVOR env
...
declare const __STABBUR_FLAVOR__: string | undefined;

/** The build flavor baked into this bundle. Defaults to "generic". */
export function flavor(): Flavor {
  return typeof __STABBUR_FLAVOR__ !== "undefined" && __STABBUR_FLAVOR__ === "dhis2" ? "dhis2" : "generic";
}
