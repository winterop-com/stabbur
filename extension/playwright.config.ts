...
//   mock  - fast, hermetic; drives the panel against an in-process stabbur API mock.
//   live  - end-to-end against a real `stabbur serve` + the public DHIS2 play demo.
//
...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      // stabbur. NOT part of the default `e2e` (mock) run. The batch verification
