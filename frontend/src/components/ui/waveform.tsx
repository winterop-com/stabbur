...
// Vendored from ElevenLabs UI (https://ui.elevenlabs.io, MIT) via its shadcn registry
// (/r/waveform.json). Local change: AudioScrubber now forwards `height` to its inner
// <Waveform> so the progress overlay lines up with the bars at any height. Keep this
// note (and re-apply the fix) if you pull a newer version from the registry.
